...
namespace DbFacade.Factories
{
        ...
        where TDbParams : DbParamsModel
    {
        ...
        public  IDbCommandParameterConfig<TDbParams> OutputByte(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Byte, size);


        public  IDbCommandParameterConfig<TDbParams> OutputSByte(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.SByte, size);


        public  IDbCommandParameterConfig<TDbParams> OutputInt16(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Int16, size);


        public  IDbCommandParameterConfig<TDbParams> OutputInt32(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Int32, size);


        public  IDbCommandParameterConfig<TDbParams> OutputInt64(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Int64, size);


        public  IDbCommandParameterConfig<TDbParams> OutputUInt16(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.UInt16, size);


        public  IDbCommandParameterConfig<TDbParams> OutputUInt32(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.UInt32, size);


        public  IDbCommandParameterConfig<TDbParams> OutputUInt64(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.UInt64, size);


        public  IDbCommandParameterConfig<TDbParams> OutputSingle(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Single, size);


        public  IDbCommandParameterConfig<TDbParams> OutputDouble(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Double, size);


        public  IDbCommandParameterConfig<TDbParams> OutputDecimal(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Decimal, size);


        public  IDbCommandParameterConfig<TDbParams> OutputBoolean(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Boolean, size);


        public  IDbCommandParameterConfig<TDbParams> OutputGuid(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Guid, size);


        public  IDbCommandParameterConfig<TDbParams> OutputTimeSpan(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Time, size);


        public  IDbCommandParameterConfig<TDbParams> OutputDateTime(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.DateTime, size);


        public  IDbCommandParameterConfig<TDbParams> OutputDateTime2(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.DateTime2, size);


        public  IDbCommandParameterConfig<TDbParams> OutputDateTimeOffset(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.DateTimeOffset, size);


        public  IDbCommandParameterConfig<TDbParams> OutputBinary(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.Binary, size);


        public  IDbCommandParameterConfig<TDbParams> OutputChar(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.StringFixedLength, size);


        public  IDbCommandParameterConfig<TDbParams> OutputString(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.String, size);


        public  IDbCommandParameterConfig<TDbParams> OutputCharArray(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.String, size);


        public  IDbCommandParameterConfig<TDbParams> OutputAnsiStringFixedLength(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.AnsiStringFixedLength, size);


        public  IDbCommandParameterConfig<TDbParams> OutputAnsiString(int size)
        => DbCommandParameterConfig<TDbParams>.CreateOutput(DbType.AnsiString, size);


        public  IDbCommandParameterConfig<TDbParams> OutputXml(int size)
        ...
        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputByteAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Byte, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputSByteAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.SByte, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputInt16Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Int16, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputInt32Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Int32, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputInt64Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Int64, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputUInt16Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.UInt16, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputUInt32Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.UInt32, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputUInt64Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.UInt64, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputSingleAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Single, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputDoubleAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Double, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputDecimalAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Decimal, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputBooleanAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Boolean, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputGuidAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Guid, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputTimeSpanAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Time, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputDateTimeAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.DateTime, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputDateTime2Async(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.DateTime2, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputDateTimeOffsetAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.DateTimeOffset, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputBinaryAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.Binary, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputCharAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.StringFixedLength, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputStringAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.String, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputCharArrayAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.String, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputAnsiStringFixedLengthAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.AnsiStringFixedLength, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputAnsiStringAsync(int size)
        => await DbCommandParameterConfig<TDbParams>.CreateOutputAsync(DbType.AnsiString, size);


        public  async Task<IDbCommandParameterConfig<TDbParams>> OutputXmlAsync(int size)
