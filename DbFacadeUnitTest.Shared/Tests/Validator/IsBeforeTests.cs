...
namespace DbFacadeUnitTests.Tests.Validator
{
    ...
    public class IsBeforeTests : ValidatorTestBase
    {
        ...
        public void WithStringValue()
        {
            UnitTestValidator Validator = new UnitTestValidator()
            {
                UnitTestRules.IsBefore(model => model.DateTimeString, DateTime1979.AddYears(1),"dd/MM/yyyy"),
        ...
        public void WithStringValueFail()
        {
            UnitTestValidator Validator = new UnitTestValidator()
            {
                UnitTestRules.IsBefore(model => model.DateTimeString, DateTime1979,"dd/MM/yyyy"),
        ...
        public void WithValueAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.Today, Tomorrow)
                    );
        ...
        public void WithValueFailAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.Today, Yesterday)
                    );
                var result = await validator.ValidateAsync(Parameters);
        ...
        public void WithOptionalValueAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.TodayOptional, Tomorrow)
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsValidAsync(result);
            });
        ...
        public void WithOptionalValueNullAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.DateTimeNull, Today)
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsValidAsync(result);
            });
        ...
        public void WithOptionalValueFailAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.TodayOptional, Yesterday)
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsInvalidAsync(result);
                await HasCorrectErrorCountAsync(result, 1);
        ...
        public void WithStringValueAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.DateTimeString, DateTime1979.AddYears(1), "dd/MM/yyyy"),
                    await UnitTestRules.IsBeforeAsync(model => model.DateTimeStringAlt, DateTime1979Alt.AddYears(1), "dd-MM-yyyy")
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsValidAsync(result);
            });
        ...
        public void WithStringOptionalValueAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.DateTimeString, DateTime1979.AddYears(1), "dd/MM/yyyy", true),
                    await UnitTestRules.IsBeforeAsync(model => model.DateTimeStringAlt, DateTime1979Alt.AddYears(1), "dd-MM-yyyy", true)
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsValidAsync(result);
            });
        ...
        public void WithStringOptionalNullValueAsync()
        {
            RunAsAsyc(async () => {
                var validator = await UnitTestValidator.CreateAsync(
                    await UnitTestRules.IsBeforeAsync(model => model.StringNumNull, DateTime1979.AddYears(1), "dd/MM/yyyy", true),
                    await UnitTestRules.IsBeforeAsync(model => model.StringNumNull, DateTime1979Alt.AddYears(1), "dd-MM-yyyy", true)
                    );
                var result = await validator.ValidateAsync(Parameters);
                await IsValidAsync(result);
            });
